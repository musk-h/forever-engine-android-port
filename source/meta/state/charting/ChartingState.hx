...
class ChartingState extends MusicBeatState
{
	...
	var keySpace:FlxButton;
	var keyShift:FlxButton;
	...
	override public function create()
	{
        ...
        keyShift = new FlxButton(60, 200, "");
        keyShift.loadGraphic('assets/android/menu/keyshift.png');
        keyShift.alpha = 0.75;
        add(keyShift);
	...
	override public function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.ENTER #if MOBILE_CONTROLS || controls.ACCEPT || HSys.androidBack() #end)
		{
